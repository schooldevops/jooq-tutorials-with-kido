...
public class CreateDbTest {
    ...
    public void createDatabaseAndTables() {
        ...
        try (Connection conn = DriverManager.getConnection(urlDB, "postgres", "postgres");
            ...
            System.out.println("jooq_dynamic_search Database created successfully!");
        } catch (Exception e) {
            System.out.println("DB likely exists: " + e.getMessage());
        }

        String urlTarget = "jdbc:postgresql://localhost:5432/jooq_dynamic_search";
        try (Connection connTarget = DriverManager.getConnection(urlTarget, "postgres", "postgres");
            ...
            String sql = new String(Files.readAllBytes(Paths.get("src/main/resources/db/migration/V1__init_dynamic_search.sql")));
